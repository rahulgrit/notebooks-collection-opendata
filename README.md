...
In order to access the code, you first must make a GitHub account. If you already have one, skip ahead to step number 4. 
 ...
 4. Fork this repository by clicking on `Fork` near the top right hand corner. This creates your own personal copy of the master branch for you to edit and run. 
 ![Alt text](https://github.com/amcdouga/Screenshots/Screen Shot 2020-05-28 at 5.56.17 pm.png)
